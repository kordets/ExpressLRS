...
Servo ch1;
#if SERVO_USE_LPF
static LPF DRAM_ATTR lpf_ch1(LPF_SMOOTHING_FACTOR);
#endif // SERVO_USE_LPF
#endif
#if (SERVO_PIN_CH1 != UNDEF_PIN)
Servo ch2;
#if SERVO_USE_LPF
static LPF DRAM_ATTR lpf_ch2(LPF_SMOOTHING_FACTOR);
#endif // SERVO_USE_LPF
#endif
#if (SERVO_PIN_CH1 != UNDEF_PIN)
Servo ch3;
#if SERVO_USE_LPF
static LPF DRAM_ATTR lpf_ch3(LPF_SMOOTHING_FACTOR);
#endif // SERVO_USE_LPF
#endif
#if (SERVO_PIN_CH1 != UNDEF_PIN)
Servo ch4;
#if SERVO_USE_LPF
static LPF DRAM_ATTR lpf_ch4(LPF_SMOOTHING_FACTOR);
#endif // SERVO_USE_LPF
#endif
